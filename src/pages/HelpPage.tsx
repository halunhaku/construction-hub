...
const STEPS: { title: string; steps: string[]; note?: string }[] = [
  ...
  },
  {
    title: '独立布控（扫码出图）',
    steps: [
      '首页点「设置布控区域」，或直接扫布控列表页上的入口二维码',
      '进入新建页后填写起始桩号、作业区长度、方向和施工位置，页面会实时预览布置图',
      '点「保存布控区域」进入详情，再导出 PNG / JPG / PDF',
      '详情页有这张布控自己的二维码：下载后发群，对方扫开即可看图、导出',
    ],
    note: '入口码始终打开空白新建页；已保存布控的码打开对应详情页。可长按保存二维码，或点「下载二维码」得到带标题的图片。',
  },
  {
    title: '作业区布置图',
    steps: [
